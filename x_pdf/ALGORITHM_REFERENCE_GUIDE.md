...
> - Search by: **Week number** (e.g., "Week 5"), **Algorithm name** (e.g., "Kadane"), **Complexity** (e.g., "O(n)"), or **Problem type** (e.g., "Graph")
> - All algorithms start with 🔷 symbol for easy spotting
> - Click on links in Table of Contents to jump directly to sections
...
### 🔍 **SEARCH BY ALGORITHM**
| Algorithm | Week | Complexity | Type |
|-----------|------|------------|------|
| [Kadane's Algorithm](#algorithm-kadanes-algorithm-maximum-subarray-sum) | Week 1 | O(n) | Array |
| [Divide and Conquer](#algorithm-divide-and-conquer) | Week 2 | O(n log n) | Pattern |
| [Balance Split](#algorithm-balance-split) | Week 2 | O(2^n) | Partition |
| [Rod Cutting](#algorithm-rod-cutting-problem-dp) | Week 3 | O(n²) | DP |
| [Coin Change](#algorithm-minimum-coin-change-dp) | Week 3 | O(V×n) | DP |
| [Memoization](#algorithm-top-down-dp-with-memoization) | Week 4 | O(n×W) | DP |
| [0/1 Knapsack (Memoized)](#algorithm-01-knapsack-memoized) | Week 4 | O(n×W) | DP |
| [Edit Distance](#algorithm-levenshtein-distance-edit-distance) | Week 5 | O(m×n) | DP |
| [LCS](#algorithm-longest-common-subsequence-lcs) | Week 6 | O(m×n) | DP |
| [Knapsack (Bottom-Up)](#algorithm-knapsack-bottom-up-dp) | Week 6 | O(n×W) | DP |
| [M3 Tiling](#algorithm-m3-tile-problem-tiling-dp) | Week 7 | O(n) | DP |
| [Shoe Shopping](#algorithm-shoe-shopping-optimization-dp) | Week 7 | O(n²) | DP |
| [N-Queens](#algorithm-n-queens-problem-backtracking) | Week 8 | O(n!) | Backtracking |
| [BFS](#algorithm-breadth-first-search-bfs) | Week 8 | O(V+E) | Graph |
| [Maze Running](#algorithm-maze-running-dfsbfs) | Week 8 | O(rows×cols) | Graph |
| [IDS](#algorithm-iterative-deepening-search-ids) | Week 9 | O(b^d) | Search |
| [IDA*](#algorithm-ida-iterative-deepening-a) | Week 9 | O(b^d) | Search |
| [UCS](#algorithm-uniform-cost-search-ucs) | Week 9 | O(E log V) | Search |
| [Activity Selection](#algorithm-activity-selection-greedy) | Week 10 | O(n log n) | Greedy |
| [MST (Kruskal/Prim)](#algorithm-minimum-spanning-tree-kruskals-prims) | Week 10 | O(E log E) | Greedy |
| [Union-Find](#algorithm-union-find-disjoint-sets) | Week 10 | O(α(n)) | Data Structure |
| [Fast Exponentiation](#algorithm-fast-exponentiation-binary-exponentiation) | Week 11 | O(log n) | Math |
| [Max Subarray (D&C)](#algorithm-maximum-subarray-divide-and-conquer) | Week 11 | O(n log n) | Divide & Conquer |
| [Branch & Bound](#algorithm-branch-and-bound-knapsack) | Week 12 | O(2^n) | Optimization |
| [DFS with Pruning](#algorithm-dfs-with-pruning) | Week 12 | O(b^d) | Search |
| [BFS State Space](#algorithm-bfs-for-state-space-search-flappy-bird) | Week 13 | O(states) | Graph |
| [Connected Components](#algorithm-connected-components-dfsbfs) | Week 13 | O(V+E) | Graph |

### 🎯 **SEARCH BY TYPE**
- **Dynamic Programming (DP)**: Kadane's, Rod Cutting, Coin Change, Knapsack, Edit Distance, LCS, Tiling, Shoe Shopping
- **Graph Algorithms**: BFS, DFS, Maze, IDS, IDA*, UCS, Connected Components
- **Greedy**: Activity Selection, MST (Kruskal/Prim)
- **Backtracking**: N-Queens, Balance Split
- **Divide & Conquer**: Max Subarray, Fast Exponentiation
- **Optimization**: Branch & Bound, Pruning

### 🔎 **SEARCH BY PROBLEM PATTERN**
- **Array Maximum/Minimum**: Kadane's, Max Subarray
- **Pathfinding**: BFS, DFS, IDS, IDA*, UCS
- **Optimization with Constraints**: Knapsack, Rod Cutting, Coin Change
- **String Problems**: Edit Distance, LCS
- **Graph Connectivity**: BFS, DFS, Connected Components, Union-Find
- **Scheduling/Selection**: Activity Selection, Greedy
- **Counting Ways**: Tiling DP, Combinatorial DP
- **Tree Building**: MST (Kruskal/Prim)
- **Constraint Satisfaction**: N-Queens, Backtracking
- **State Space Search**: Flappy Bird, Maze Running

### ⚡ **COMPLEXITY QUICK REFERENCE**
| Complexity | Algorithms |
|------------|-----------|
| **O(n)** | Kadane's, Tiling, Union-Find |
| **O(n log n)** | D&C, Activity Selection, Fast Exp |
